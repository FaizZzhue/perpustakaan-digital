...
<div class="bg-white/30 backdrop-blur-xl border border-white/20 shadow-2xl p-8 rounded-3xl w-full max-w-xl">
    ...
    <form action="{{ route('members.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="name" value="{{ old('name') }}" class="w-full border p-3 rounded-2xl bg-white/50 border-white/40 focus:outline-none focus:ring-2 focus:ring-blue-400" required>
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="nik" value="{{ old('nik') }}" class="w-full border p-3 rounded-2xl bg-white/50 border-white/40 focus:outline-none focus:ring-2 focus:ring-blue-400" placeholder="16 digit nomor induk" required>
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="email" name="email" value="{{ old('email') }}" class="w-full border p-3 rounded-2xl bg-white/50 border-white/40 focus:outline-none focus:ring-2 focus:ring-blue-400" placeholder="contoh@domain.com" required>
        </div>
        ...
        <div class="mb-4">
            ...
            <textarea name="address" class="w-full border p-3 rounded-2xl bg-white/50 border-white/40 focus:outline-none focus:ring-2 focus:ring-blue-400" rows="3" required>{{ old('address') }}</textarea>
        </div>
        ...
        <div class="flex gap-4 mt-6">
            <button type="submit" class="px-6 py-3 rounded-2xl bg-blue-600 text-white font-semibold shadow-lg hover:scale-105 hover:bg-blue-700 transition duration-300">
                Simpan Anggota
            </button>
